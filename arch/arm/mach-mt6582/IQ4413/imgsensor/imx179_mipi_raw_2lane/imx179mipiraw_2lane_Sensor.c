...
#include "imx179mipiraw_2lane_Sensor.h"
#include "imx179mipiraw_2lane_Camera_Sensor_para.h"
#include "imx179mipiraw_2lane_CameraCustomized.h"
...
kal_uint16 IMX179MIPI_MAX_EXPOSURE_LINES = IMX179MIPI_PV_FRAME_LENGTH_LINES-4;//650;
...
{	//77 capture setting
	...
	IMX179MIPI_write_cmos_sensor(0x0103, 0x01);//SW reset
	mdelay(10);
	IMX179MIPI_write_cmos_sensor(0x0101, 0x03); 		                //0100        00   00
	IMX179MIPI_write_cmos_sensor(0x030E, 0x01); 	                  //0101        00   00
	IMX179MIPI_write_cmos_sensor(0x0202, 0x08); 		                //0202        07   08
	IMX179MIPI_write_cmos_sensor(0x0203, 0x04);                     //0203        6C   04
	//PLL setting                                                   //                 
	IMX179MIPI_write_cmos_sensor(0x0301, 0x0A); 		                //0301        0A   0A 
	IMX179MIPI_write_cmos_sensor(0x0303, 0x01); 		                //0303        01   01 
	IMX179MIPI_write_cmos_sensor(0x0305, 0x06); 		                //0305        06   06 
	IMX179MIPI_write_cmos_sensor(0x0309, 0x0A); 		                //0309        0A   0A 
	IMX179MIPI_write_cmos_sensor(0x030B, 0x01); 		                //030B        01   01 
	IMX179MIPI_write_cmos_sensor(0x030C, 0x00); 		                //030C        00   00 
	IMX179MIPI_write_cmos_sensor(0x030D, 0xDD);                     //030D        DD   DD 
	IMX179MIPI_write_cmos_sensor(0x030E, 0x01);                     //                  
                                                                  //                  
	IMX179MIPI_write_cmos_sensor(0x0340, 0x08);                     //0340        07   08 
	IMX179MIPI_write_cmos_sensor(0x0341, 0x08); 		                //0341        70   08 
	IMX179MIPI_write_cmos_sensor(0x0342, 0x0D); 		                //0342        0D   0D 
	IMX179MIPI_write_cmos_sensor(0x0343, 0x70); 		                //0343        70   70 
	IMX179MIPI_write_cmos_sensor(0x0344, 0x00); 		                //0344        00   00 
	IMX179MIPI_write_cmos_sensor(0x0345, 0x00); 		                //0345        00   00 
	IMX179MIPI_write_cmos_sensor(0x0346, 0x00); 		                //0346        01   00 
	IMX179MIPI_write_cmos_sensor(0x0347, 0xDE); 		                //0347        36   DE 
	IMX179MIPI_write_cmos_sensor(0x0348, 0x0C); 		                //0348        0C   0C 
	IMX179MIPI_write_cmos_sensor(0x0349, 0xCF); 		                //0349        CF   CF 
	IMX179MIPI_write_cmos_sensor(0x034A, 0x08); 		                //034A        08   08 
	IMX179MIPI_write_cmos_sensor(0x034B, 0xC1); 		                //034B        6B   C1 
	IMX179MIPI_write_cmos_sensor(0x034C, 0x07); 		                //034C        07   07 
	IMX179MIPI_write_cmos_sensor(0x034D, 0x88); 		                //034D        94   88 
	IMX179MIPI_write_cmos_sensor(0x034E, 0x04); 		                //034E        04   04 
	IMX179MIPI_write_cmos_sensor(0x034F, 0x44); 		                //034F        44   44 
	IMX179MIPI_write_cmos_sensor(0x0383, 0x01); 		                //0383        01   01 
	IMX179MIPI_write_cmos_sensor(0x0387, 0x01); 		                //0387        01   01 
	IMX179MIPI_write_cmos_sensor(0x0390, 0x00); 		                //0390        00   00 
	IMX179MIPI_write_cmos_sensor(0x0401, 0x02); 		                //0401        02   02 
	IMX179MIPI_write_cmos_sensor(0x0405, 0x1B); 		                //0405        1B   1B 
	IMX179MIPI_write_cmos_sensor(0x3020, 0x10); 		                //3020        10   10 
	IMX179MIPI_write_cmos_sensor(0x3041, 0x15); 		                //3041        15   15 
	IMX179MIPI_write_cmos_sensor(0x3042, 0x87); 		                //3042        87   87 
	IMX179MIPI_write_cmos_sensor(0x3089, 0x4F); 		                //3089        4F   4F 
	IMX179MIPI_write_cmos_sensor(0x3309, 0x9A); 		                //3309        9A   9A 
	IMX179MIPI_write_cmos_sensor(0x3344, 0x6F); 		                //3344        6F   6F 
	IMX179MIPI_write_cmos_sensor(0x3345, 0x1F); 		                //3345        1F   1F 
	IMX179MIPI_write_cmos_sensor(0x3362, 0x0A); 		                //3362        0A   0A 
	IMX179MIPI_write_cmos_sensor(0x3363, 0x0A); 		                //3363        0A   0A 
	IMX179MIPI_write_cmos_sensor(0x3364, 0x02); 		                //3364        02   02 
	IMX179MIPI_write_cmos_sensor(0x3368, 0x18); 		                //3368        18   18 
	IMX179MIPI_write_cmos_sensor(0x3369, 0x00); 		                //3369        00   00 
	IMX179MIPI_write_cmos_sensor(0x3370, 0x7F); 		                //3370        7F   7F 
	IMX179MIPI_write_cmos_sensor(0x3371, 0x37); 		                //3371        37   37 
	IMX179MIPI_write_cmos_sensor(0x3372, 0x67); 		                //3372        67   67 
	IMX179MIPI_write_cmos_sensor(0x3373, 0x3F); 		                //3373        3F   3F 
	IMX179MIPI_write_cmos_sensor(0x3374, 0x3F); 		                //3374        3F   3F 
	IMX179MIPI_write_cmos_sensor(0x3375, 0x47); 		                //3375        47   47 
	IMX179MIPI_write_cmos_sensor(0x3376, 0xCF); 		                //3376        CF   CF 
	IMX179MIPI_write_cmos_sensor(0x3377, 0x47); 		                //3377        47   47 
	IMX179MIPI_write_cmos_sensor(0x33C8, 0x00); 		                //33C8        00   00 
	IMX179MIPI_write_cmos_sensor(0x33D4, 0x0C); 		                //33D4        0C   0C 
	IMX179MIPI_write_cmos_sensor(0x33D5, 0xD0); 		                //33D5        D0   D0 
	IMX179MIPI_write_cmos_sensor(0x33D6, 0x07); 	                  //33D6        07   07 
	IMX179MIPI_write_cmos_sensor(0x33D7, 0xE4); 	                  //33D7        36   E4 
	IMX179MIPI_write_cmos_sensor(0x4100, 0x0E); 	                  //4100        0E   0E 
	IMX179MIPI_write_cmos_sensor(0x4108, 0x01);                     //4108        01   01
	IMX179MIPI_write_cmos_sensor(0x4109, 0x7C);                     //4109        7C   7C
	IMX179MIPI_write_cmos_sensor(0x0104, 0x00);//group
	IMX179MIPI_write_cmos_sensor(0x0100, 0x01);//STREAM ON
...
UINT32 IMX179MIPIOpen(void)
{
    ...
    do {
	   ...
	   spin_unlock(&imx179_drv_lock);
		if (IMX179MIPI_sensor_id == IMX179MIPI_2lane_SENSOR_ID)
		break; 
...
UINT32 IMX179MIPIGetSensorID(UINT32 *sensorID) 
{
    ...
    do {		
	   *sensorID =(kal_uint16)(((IMX179MIPI_read_cmos_sensor(0x0002)&&0x0f)<<8) | IMX179MIPI_read_cmos_sensor(0x0003)); 
        if (*sensorID == IMX179MIPI_2lane_SENSOR_ID)
            break;
        SENSORDB("Read Sensor ID Fail = 0x%04x\n", *sensorID); 
        retry--; 
    } while (retry > 0);
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_REGISTER_DEFAULT:
            if (*pFeatureParaLen>=sizeof(NVRAM_SENSOR_DATA_STRUCT))
            {
                ...
                pSensorDefaultData->SensorId=IMX179MIPI_2lane_SENSOR_ID;
